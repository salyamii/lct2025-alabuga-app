...
import { ArrowLeft, Bell, Check, Trophy, Rocket, Users, Star, Clock, X } from "lucide-react";
...
interface NotificationsScreenProps {
  ...
  export function NotificationsScreen({ onBack }: NotificationsScreenProps) {
    const notifications = [
      {
        ...
        message: "Вы заработали значок 'React Навигатор' за выполнение продвинутых миссий по React",
      ...
      },
      {
        ...
        type: "mission",
        title: "Миссия готова",
        message: "Ваша эскадрилья готова запустить 'Протокол навигации галактического флота'",
      ...
      },
      {
        ...
        message: "Новый эпизод 'Космические рубежи' теперь доступен в сезоне 2024-Q1",
      ...
      },
      {
        ...
        type: "reminder",
        title: "Срок миссии",
        message: "Ваша активная миссия 'Оптимизация базы данных' истекает через 2 дня",
    ...
    const getTypeColor = (type: string) => {
      switch (type) {
        case "achievement": return "bg-rewards-amber/10 border-rewards-amber/20";
        case "mission": return "bg-primary/10 border-primary/20";
        case "mentorship": return "bg-info/10 border-info/20";
    ...
    const getTypeLabel = (type: string) => {
      switch (type) {
        ...
        case "mission": return "Миссия";
        case "mentorship": return "Наставничество";
...
Назад
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-bold">Центр управления</h1>
                <p className="text-sm text-muted-foreground">
                  {unreadCount > 0 ? `${unreadCount} непрочитанных уведомлений` : "Все актуально!"}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-3">
          {notifications.map((notification) => {
            ...
            return (
              <Card 
                key={notification.id} 
                className={`notification-card ${!notification.read ? 'orbital-border-enhanced' : 'orbital-border'} ${getTypeColor(notification.type)}`}
              >
        ...
        {notifications.length === 0 && (
          <Card className="orbital-border">
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Вы в курсе всех событий! Проверьте позже для обновлений миссий и достижений.
              </p>
            </CardContent>
          </Card>
        )}
