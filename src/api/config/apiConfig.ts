...
export const API_ENDPOINTS = {
  ...
  USERS: {
    ME: '/users/me',
    LIST: '/users',
    GET: (userLogin: string) => `/users/${userLogin}`,
    UPDATE: (userLogin: string) => `/users/${userLogin}`,
    MISSIONS_LIST: '/users/missions/list',
    MISSIONS_LIST_BY_LOGIN: (userLogin: string) => `/users/${userLogin}/missions/list`,
    MISSION: (missionId: number) => `/users/missions/${missionId}`,
    APPROVE_MISSION: (missionId: number) => `/users/missions/${missionId}/approve`,
    ADD_ARTIFACT: (userLogin: string, artifactId: number) => `/users/${userLogin}/artifacts/${artifactId}`,
    REMOVE_ARTIFACT: (userLogin: string, artifactId: number) => `/users/${userLogin}/artifacts/${artifactId}`,
    ADD_COMPETENCY: (userLogin: string, competencyId: number) => `/users/${userLogin}/competencies/${competencyId}`,
    UPDATE_COMPETENCY: (userLogin: string, competencyId: number) => `/users/${userLogin}/competencies/${competencyId}`,
    REMOVE_COMPETENCY: (userLogin: string, competencyId: number) => `/users/${userLogin}/competencies/${competencyId}`,
    ADD_SKILL: (userLogin: string, competencyId: number, skillId: number) => `/users/${userLogin}/competencies/${competencyId}/skills/${skillId}`,
    UPDATE_SKILL: (userLogin: string, competencyId: number, skillId: number) => `/users/${userLogin}/competencies/${competencyId}/skills/${skillId}`,
    REMOVE_SKILL: (userLogin: string, competencyId: number, skillId: number) => `/users/${userLogin}/competencies/${competencyId}/skills/${skillId}`,
    COMPLETE_TASK: (taskId: number) => `/users/tasks/${taskId}/complete`,
  },
  ARTIFACTS: {
    LIST: '/artifacts',
    CREATE: '/artifacts',
